...
public class DynamicContentValidator {
   ...
   //file name should be different from other utilities for validateDynamicContent and directoryPath for csv report should be under src/main/resource/BrokenDynamicContentReport/ and for screenshot should be under src/main/resource/BrokenDynamicContentScreenshot/ 
